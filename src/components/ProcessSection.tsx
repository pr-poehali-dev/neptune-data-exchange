...
const steps = [
  {
    ...
    description:
      "Мастер регистрируется и заполняет профиль: специализация, город, опыт и контактные данные. Это займёт не больше 5 минут.",
    number: "01",
  },
  {
    icon: PaletteIcon,
    ...
    description:
      "Загружайте фотографии своих проектов с описанием: что сделано, какие материалы, сколько стоило. Чем больше деталей — тем выше интерес заказчиков.",
    number: "02",
  },
  {
    icon: Rocket,
    ...
    description:
      "Заказчики находят ваши работы, изучают профиль и пишут напрямую. Никаких посредников — только вы и клиент.",
    number: "03",
  },
]
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            Три шага до <span className="text-primary">первого клиента</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Разместить свои работы и начать получать заявки — просто и быстро.
          </p>
        </div>
